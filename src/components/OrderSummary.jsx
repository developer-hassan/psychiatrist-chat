            ...
            <div className="w-full mx-auto mt-8 xl:mt-0 px-6 sm:px-0 xl:w-[400px] max-w-[400px]">
                ...
                <div
                    ...
                    <div
                        ...
                        <h5 className="font-medium text-lg text-white mb-3">Room Service</h5>
                        <p className="text-white mb-1">Room number: <span>{orderDetail?.room_no}</span></p>
                        <p className="text-white mb-1">Time ordered: <span>{time}</span></p>
