...
import {setSelectedHotel} from "../store/home/homeSlice"

export default function HotelsSelect() {
    const [selected, setSelected] = useState(null);
    const [query, setQuery] = useState('');
    const {hotels} = useSelector((state) => state.home);
    const dispatch = useDispatch()

    useEffect(() => {
        dispatch(setSelectedHotel(selected));
    }, [dispatch, selected]);
            ...
            <div className="relative">
                <div
                    ...
                    <Combobox.Input
                        ...
                        displayValue={(hotel) => hotel ? hotel.hotel_name : "Select hotel..."}
